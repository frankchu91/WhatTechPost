...
cover_image: https://raw.githubusercontent.com/frankchu91/WhatTechPost/main/assets/2026-08-15-tldv.png
---
...
![tl;dv data exposure by the numbers: 181,874 meeting records, 84,312 users, 35,003 organizations — reported January, patched around public disclosure in early August](https://raw.githubusercontent.com/frankchu91/WhatTechPost/main/assets/2026-08-15-tldv-stat.png)
...
The six-month disclosure timeline deserves its own sentence: a researcher reporting "all your meetings are public" and following up repeatedly without resolution is a process failure as serious as the bug. To be fair and current: tl;dv has since patched the flaw and publicly acknowledged it, describing it as two separate vulnerabilities. Good — but by the available accounts the fix landed around the public disclosure in early August, not the January report, and that gap is the part worth remembering.
